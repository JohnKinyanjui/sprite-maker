<script lang="ts">
  ...
  let { workspaces, workspace, worktrees, conversations, selectedWorktreeId, selectedConversationId, runningConversationIds, activeView, onView, onProject, onAddProject, onConversation, onNewConversation, onRenameConversation, onArchiveConversation, onSettings, onManageProject }: {
...
<aside class="sidebar">
  ...
  <footer><button onclick={onSettings}><SlidersHorizontal size={15}/><span>Settings</span></button></footer>
</aside>
