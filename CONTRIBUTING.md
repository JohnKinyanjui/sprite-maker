...
Pull requests must pass the repository's automated quality check. Changes are merged only after review by the project owner or an appointed maintainer. Review approval may be withdrawn when new commits materially change the reviewed patch.
